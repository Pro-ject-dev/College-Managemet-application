...
class sem2 extends StatefulWidget {
  final String id;
  const sem2(BuildContext context, {Key? key, required this.id, required})
      : super(key: key);
                ...
                children: [
                  ...
                  for (var j = 0, i = 1, k = 0, l = 0, m = 0, n = 0;
                    ...
                    TableRow(children: [
                      ...
                      TableCell(
                        child: Center(
                            child: Text(sem2_ex1[j].toString(),
                                style: TextStyle(fontSize: 18.0))),
                      ),
                      TableCell(
                        child: Center(
                            child: Text(sem2_ex2[k].toString(),
                                style: TextStyle(fontSize: 18.0))),
                      ),
                      TableCell(
                        child: Center(
                            child: Text(sem2_ex3[l].toString(),
                                style: TextStyle(fontSize: 18.0))),
                      ),
                      TableCell(
                        child: Center(
                            child: Text(sem2_ex4[m].toString(),
                                style: TextStyle(fontSize: 18.0))),
                      ),
                      TableCell(
                        child: Center(
                            child: Text(sem2_ex5[n].toString(),
                                style: TextStyle(fontSize: 18.0))),
                      ),
                    ])
                  ]
